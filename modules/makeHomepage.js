...
const countryISO = [
  ...
  { code: "VA", code3: "VAT", name: "The Holy See", number: "336" },
...
module.exports = (home, card) => {
  ...
  countryISO.forEach((el) => {
    //     const options = {
    //       method: "GET",
    //       url: "https://covid-19-statistics.p.rapidapi.com/reports",
    //       params: { date: "2020-04-16", iso: el.code3 },
    //       headers: {
    ...
    let currCard = card.replace(/{%IMAGE%}/g, flag(el.code));
    currCard = currCard.replace(/{%COUNTRY%}/g, el.name);
    currCard = currCard.replace(/{%CON%}/g, "12345");
    currCard = currCard.replace(/{%ISO%}/g, el.code3);

    if (flag(el.code)) allCards = allCards + currCard;
  });

  const finalHTML = home.replace(/{%COUNTRY_CARDS%}/g, allCards);
  return finalHTML;
};
